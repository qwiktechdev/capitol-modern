      ...
      <div className="auth-shell flex items-center justify-center px-4 py-16">
        ...
        <div className="auth-card !max-w-lg">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">Join De Capitol and bank without borders</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input type="tel" className="input-field" placeholder="+1 234 567 8900" value={number} onChange={(e) => setNumber(e.target.value)} required />
            </div>
